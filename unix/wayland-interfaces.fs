...
?include-wayland text-input-unstable-v3.c [IF]
...
[THEN]
?include-wayland xdg-shell.c [IF]
...
[THEN]
?include-wayland xdg-decoration-unstable-v1.c [IF]
...
[THEN]
?include-wayland primary-selection-unstable-v1.c [IF]
...
[THEN]
?include-wayland tablet-unstable-v2.c [IF]
...
[THEN]
?include-wayland fractional-scale-v1.c [IF]
...
[THEN]
?include-wayland idle-inhibit-unstable-v1.c [IF]
...
[THEN]
?include-wayland tearing-control-v1.c [IF]
...
[THEN]
?include-wayland color-management-v1.c [IF]
...
[THEN]
?include-wayland color-representation-v1.c [IF]
