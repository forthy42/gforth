...
// exec: sed -e s/JNINativeInterface-/JNIEnv-/g -e s/JNIInvokeInterface-/JavaVM-/g -e 's/\(c-function .*\)/\\ \1/g' -e 's/\(ReleaseStringUTFChars.*\) a a s/\1 a a a/g' | grep -v '\.\.\. --' -e 's/s" c" add-lib/s" ((struct JNI:*(Cell*)(x.spx[arg0])" ptr-declare $+\[]!/g'
