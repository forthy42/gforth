...
\ Copyright (C) 1995,2000,2003,2004,2006,2007,2008,2010,2013,2014,2015,2016,2017,2018,2019,2020,2021 Free Software Foundation, Inc.
...
: see ( "<spaces>name" -- ) \ tools
    ...
    \G etc.) is lost.
    name name-too-short? find-name dup 0= -&13 and throw name-see ;
