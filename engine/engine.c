...
#define LABEL(name) H_##name: asm("# I " #name); I_##name:
#define LABEL3(name) J_##name: asm("# J " #name);
...
#define VARIANT(v)	(v)
#define JUMP(target)	goto I_noop
#define LABEL(name) H_##name: asm("# H " #name); SKIP16; asm("# I " #name); I_##name:
...
#define LABEL3(name) J_##name: asm("# J " #name); SKIP16;
...
#define LABEL2(name) K_##name: asm("# K " #name);
