...
$(ls lib/gforth/$VERSION/386/libcc-named/.libs/*.dll | sed -e 's:/:\\:g' -e 's,^\(..*\)$,Source: "C:\\cygwin'$(pwd | sed -e "s,/,\\\\,g")'\1"; DestDir: "{app}\\lib\\gforth\\'$VERSION'\\386\\libcc-named\\.libs"; Check: not Is64BitInstallMode,g')
