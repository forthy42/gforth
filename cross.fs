...
\ Copyright (C) 1995,1996,1997,1998,1999,2000,2003,2004,2005,2006,2007,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020 Free Software Foundation, Inc.
...
ghost translate drop
Builder translator:
Build: ( xtint xtcomp xtpost --- )
    T rot A, swap A, A, H 7 0 DO [T'] no.extensions X A, LOOP ;Build
by: :dodoes ;DO
vt: [G'] does, gset-optimizer
[G'] translate gset-extra  ;vt
