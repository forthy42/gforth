/* DEC Alpha
  ...
  Copyright (C) 1995,1996,1997,1998,2000,2003,2005,2007,2018,2019 Free Software Foundation, Inc.
...
#define BFD_ARCH bfd_arch_alpha
#define BFD_MACH bfd_mach_alpha_ev6
