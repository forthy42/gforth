...
public class Gforth
	...
	if ((Context.checkSelfPermission(this, android.permission.WRITE_EXTERNAL_STORAGE)
	     != PackageManager.PERMISSION_GRANTED) ||
	    (Context.checkSelfPermission(this, android.permission.READ_EXTERNAL_STORAGE)
	     != PackageManager.PERMISSION_GRANTED)) {
