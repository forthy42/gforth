...
#Copyright (C) 2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2023,2024,2025 Free Software Foundation, Inc.
...
cp $TOOLCHAIN/sysroot/usr/lib/libsharpyuv.so $LIBS
