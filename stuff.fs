...
\ Copyright (C) 1996,1997,1998,2000,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017 Free Software Foundation, Inc.
...
: defer@, ( xt -- )
    dup >namevt @ >vtdefer@ @
    dup >namevt @ >vtcompile, @ ['] :, = IF  swap lit,  THEN  opt-compile, ;
