...
: rec-f83 ( addr len wordlist-id-addr -- nt nt-translate / notfound )
    @ (listlfind) nt>rec ;
...
' no.extensions dup dup translator: notfound
...
Defer rec-nt ( addr u -- nt nt-translate | notfound )
