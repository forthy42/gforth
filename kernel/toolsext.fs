...
\ Copyright (C) 1995,1998,2000,2003,2005,2007,2009,2010,2012,2013,2015,2016,2017,2018,2019,2020,2021 Free Software Foundation, Inc.
...
: dummy ;  immediate
: scan-rec  @ (listlfind)  dup 0=  IF  drop ['] dummy  THEN  ['] recognized-nt ;
