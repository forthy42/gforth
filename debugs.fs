...
\ Copyright (C) 1995,1997,1999,2002,2003,2004,2005,2006,2007,2009,2011,2012,2013,2014,2016,2017 Free Software Foundation, Inc.
...
:noname .s fdepth IF cr ." F:" f.s THEN ; IS printdebugdata
