...
\ Copyright (C) 1995,1997,1999,2002,2003,2004,2005,2006,2007,2009,2011,2012,2013,2014,2016,2017,2018,2019,2020 Free Software Foundation, Inc.
...
: view' ( "name" -- xt )
    ...
    forth-recognize  dup translate-nt? IF  swap rec' !  THEN
