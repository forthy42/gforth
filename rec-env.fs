...
\ Copyright (C) 2016,2017,2019,2021 Free Software Foundation, Inc.
...
' getenv ' env$, ' slit, >postponer recognized: recognized-env
' recognized-env Constant rectype-env
