...
install_linux() {
  ...
  sudo apt-get -y install gforth gforth-lib gforth-common libffi-dev libltdl7 libsoil-dev libtool make gcc automake install-info yodl bison libpcre3-dev libboost-dev git g++ # yodl, bison, ... git: are for swig
