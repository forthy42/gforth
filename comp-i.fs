...
\ Copyright (C) 1996,1997,1998,2002,2003,2004,2007,2010,2012,2013,2015,2016,2017,2019,2021,2023,2024,2025 Free Software Foundation, Inc.
...
: set-image-offsets ( -- )
    ...
    ."    xt" [ r@ cell+     ]L 22 cells image-data to xoffset to xbase
    ." label" [ r> 2 cells + ]L 18 cells image-data to loffset to lbase ;
